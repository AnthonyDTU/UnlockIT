...
struct Room: Identifiable  {
    ...
    static let jonasUser = (User(id: "1", name: "Jonas", email: "Jensen", department: "Engineering", companyPosition: "Student engineer", password: "pwd", privilege: 2, isAdmin: false))
    static let spiderManUser = (User(id: "2", name: "Spider", email: "Man", department: "Operations", companyPosition: "Shopper", password: "pwd", privilege: 2, isAdmin: false))
