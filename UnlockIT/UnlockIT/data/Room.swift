...
struct Room: Identifiable  {
    ...
    static let jonasUser = (User(id: "1", employeeNumber: 25, username: "Jonas", email: "Jensen", department: "Engineering", companyPosition: "Student engineer", password: "pwd", privilege: 2, isAdmin: false))
    static let spiderManUser = (User(id: "2", employeeNumber: 26, username: "Spider", email: "Man", department: "Operations", companyPosition: "Shopper", password: "pwd", privilege: 2, isAdmin: false))
